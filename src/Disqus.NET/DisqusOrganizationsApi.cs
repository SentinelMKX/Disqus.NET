...
namespace Disqus.NET
{
    public class DisqusOrganizationsApi : DisqusApiBase, IDisqusOrganizationsApi
    {
        ...
        public async Task<DisqusResponse<DisqusAdmin>> AddAdminAsync(DisqusAccessToken accessToken,
            DisqusOrganizationAddAdminRequest request)
        {
            Collection<KeyValuePair<string, string>> parameters = Parameters
                .WithParameter("access_token", accessToken)
            ...
            return await RequestProcessor
                .ExecuteAsync<DisqusResponse<DisqusAdmin>>(DisqusRequestMethod.Post,
                    DisqusEndpoints.Organizations.AddAdmin, parameters)
                .ConfigureAwait(false);
        }

        public async Task<DisqusResponse<DisqusAdmin>> RemoveAdminAsync(DisqusAccessToken accessToken,
            DisqusOrganizationRemoveAdminRequest request)
        {
            Collection<KeyValuePair<string, string>> parameters = Parameters
                .WithParameter("access_token", accessToken)
                .WithMultipleParameters(request.Parameters);
            ...
            return await RequestProcessor
                .ExecuteAsync<DisqusResponse<DisqusAdmin>>(DisqusRequestMethod.Post,
                    DisqusEndpoints.Organizations.RemoveAdmin, parameters)
                .ConfigureAwait(false);
        }

        public async Task<DisqusResponse<DisqusAdmin>> SetRoleAsync(DisqusAccessToken accessToken,
            DisqusOrganizationSetRoleRequest request)
        {
            Collection<KeyValuePair<string, string>> parameters = Parameters
                .WithParameter("access_token", accessToken)
                .WithMultipleParameters(request.Parameters);
            ...
            return await RequestProcessor
                .ExecuteAsync<DisqusResponse<DisqusAdmin>>(DisqusRequestMethod.Post,
                    DisqusEndpoints.Organizations.SetRole, parameters)
                .ConfigureAwait(false);
        }
    }
}