...
namespace Disqus.NET.Models
{
    public class DisqusMedia
    {
        ...
        [JsonProperty("htmlWidth")] public int? HtmlWidth { get; set; }

        [JsonProperty("htmlHeight")] public int? HtmlHeight { get; set; }

        [JsonProperty("mediaType")] public string MediaType { get; set; }

        [JsonProperty("metadata")] public DisqusMediaMetadata Metadata { get; set; }
        ...
        [JsonProperty("resolvedUrl")] public string ResolvedUrl { get; set; }
    }
}