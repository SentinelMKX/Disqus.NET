...
namespace Disqus.NET
{
    public interface IDisqusPostsApi
    {
        ...
        /// <param name="request"></param>
        /// <returns></returns>
        Task<DisqusResponse<IEnumerable<DisqusPost>>> GetContextAsync(DisqusAccessToken accessToken,
        ...
        /// <param name="request"></param>
        /// <returns></returns>
        Task<CursoredDisqusResponse<IEnumerable<DisqusPost>>> ListAsync(DisqusAccessToken accessToken,
        ...
        /// <param name="request"></param>
        /// <returns></returns>
        Task<CursoredDisqusResponse<IEnumerable<DisqusPost>>> ListPopularAsync(DisqusAccessToken accessToken,
        ...
        /// <returns></returns>
        Task<DisqusResponse<DisqusPostVoteStats>>
            VoteAsync(DisqusAccessToken accessToken, long postId, DisqusVote vote);
