...
namespace Disqus.NET
{
    public interface IDisqusOrganizationsApi
    {
        ...
        /// <returns></returns>
        Task<CursoredDisqusResponse<IEnumerable<DisqusAdmin>>> ListAdminsAsync(DisqusAccessToken accessToken,
            int organization);
        ...
        /// <returns></returns>
        Task<DisqusResponse<DisqusAdmin>> AddAdminAsync(DisqusAccessToken accessToken,
        ...
        /// <param name="request"></param>
        /// <returns></returns>
        Task<DisqusResponse<DisqusAdmin>> RemoveAdminAsync(DisqusAccessToken accessToken,
        ...
        /// <param name="request"></param>
        /// <returns></returns>
        Task<DisqusResponse<DisqusAdmin>> SetRoleAsync(DisqusAccessToken accessToken,
