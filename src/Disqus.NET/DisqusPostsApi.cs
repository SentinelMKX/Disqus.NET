...
namespace Disqus.NET
{
    public class DisqusPostsApi : DisqusApiBase, IDisqusPostsApi
    {
        ...
        public async Task<DisqusResponse<IEnumerable<DisqusId>>> ApproveAsync(DisqusAccessToken accessToken,
            params string[] posts)
        {
            ...
            return await RequestProcessor
                .ExecuteAsync<DisqusResponse<IEnumerable<DisqusId>>>(DisqusRequestMethod.Post,
                    DisqusEndpoints.Posts.Approve, parameters)
        ...
        public async Task<DisqusResponse<DisqusPost>> DetailsAsync(DisqusAccessToken accessToken,
            DisqusPostDetailsRequest request)
        {
            Collection<KeyValuePair<string, string>> parameters = Parameters
                .WithMultipleParameters(request.Parameters)
                .WithOptionalParameter("access_token", accessToken);
            ...
            return await RequestProcessor
                .ExecuteAsync<DisqusResponse<DisqusPost>>(DisqusRequestMethod.Get, DisqusEndpoints.Posts.Details,
                    parameters)
                .ConfigureAwait(false);
        }
        ...
        public async Task<CursoredDisqusResponse<IEnumerable<DisqusPost>>> ListAsync(DisqusAccessToken accessToken,
            DisqusPostListRequest request)
        {
            Collection<KeyValuePair<string, string>> parameters = Parameters
                .WithMultipleParameters(request.Parameters)
                .WithOptionalParameter("access_token", accessToken);
            ...
            return await RequestProcessor
                .ExecuteAsync<CursoredDisqusResponse<IEnumerable<DisqusPost>>>(DisqusRequestMethod.Get,
                    DisqusEndpoints.Posts.List, parameters)
                .ConfigureAwait(false);
        }
            ...
            params long[] posts)
        {
            ...
            return await RequestProcessor
                .ExecuteAsync<DisqusResponse<IEnumerable<DisqusId>>>(DisqusRequestMethod.Post,
                    DisqusEndpoints.Posts.Remove, parameters)
                .ConfigureAwait(false);
        }
        ...
        public async Task<DisqusResponse<DisqusPost>> ReportAsync(DisqusAccessToken accessToken, long postId)
        {
            ...
            return await RequestProcessor
                .ExecuteAsync<DisqusResponse<DisqusPost>>(DisqusRequestMethod.Post, DisqusEndpoints.Posts.Report,
                    parameters)
                .ConfigureAwait(false);
        }
            ...
            params long[] posts)
        {
            ...
            return await RequestProcessor
                .ExecuteAsync<DisqusResponse<IEnumerable<DisqusId>>>(DisqusRequestMethod.Post,
                    DisqusEndpoints.Posts.Restore, parameters)
                .ConfigureAwait(false);
        }

        public async Task<DisqusResponse<IEnumerable<DisqusId>>> SpamAsync(DisqusAccessToken accessToken,
            params long[] posts)
        {
            Collection<KeyValuePair<string, string>> parameters = Parameters
                .WithMultipleParameters("post", posts.Select(p => p.ToString()).ToArray())
            ...
            return await RequestProcessor
                .ExecuteAsync<DisqusResponse<IEnumerable<DisqusId>>>(DisqusRequestMethod.Post,
                    DisqusEndpoints.Posts.Spam, parameters)
                .ConfigureAwait(false);
        }

        public async Task<DisqusResponse<DisqusPost>> UpdateAsync(DisqusAccessToken accessToken, long postId,
            string message)
        {
            Collection<KeyValuePair<string, string>> parameters = Parameters
                .WithParameter("post", postId.ToString())
            ...
            return await RequestProcessor
                .ExecuteAsync<DisqusResponse<DisqusPost>>(DisqusRequestMethod.Post, DisqusEndpoints.Posts.Update,
                    parameters)
                .ConfigureAwait(false);
        }
