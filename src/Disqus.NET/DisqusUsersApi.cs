    ...
    public class DisqusUsersApi : DisqusApiBase, IDisqusUsersApi
    {
        ...
        public async Task<DisqusResponse<string>> CheckUsernameAsync(DisqusAccessToken accessToken, string username)
        {
            ...
            return await RequestProcessor
                .ExecuteAsync<DisqusResponse<string>>(DisqusRequestMethod.Post, DisqusEndpoints.Users.CheckUsername,
                    parameters)
        ...
        public async Task<DisqusResponse<DisqusUser>> DetailsAsync(int userId, string accessToken = null)
        {
            ...
            return await RequestProcessor
                .ExecuteAsync<DisqusResponse<DisqusUser>>(DisqusRequestMethod.Get, DisqusEndpoints.Users.Details,
                    parameters)
                .ConfigureAwait(false);
        }
        ...
        public async Task FollowAsync(DisqusAccessToken accessToken, int userId)
        {
            ...
            await RequestProcessor
                .ExecuteAsync<DisqusResponse<List<string>>>(DisqusRequestMethod.Post, DisqusEndpoints.Users.Follow,
                    parameters)
                .ConfigureAwait(false);
        }
        ...
        public async Task<CursoredDisqusResponse<IEnumerable<DisqusInterestingObject<DisqusUser>>>>
        ...
        public async Task<CursoredDisqusResponse<IEnumerable<DisqusInterestingObject<DisqusUser>>>>
            InterestingUsersAsync(int limit)
        {
            return await InterestingUsersAsync(null, limit).ConfigureAwait(false);
        }

        public async Task<CursoredDisqusResponse<IEnumerable<DisqusUserActivity>>> ListActivityAsync(
            DisqusAccessToken accessToken, DisqusUserListActivityRequest request)
        {
            Collection<KeyValuePair<string, string>> parameters = Parameters
                .WithOptionalParameter("access_token", accessToken)
            ...
            return await RequestProcessor
                .ExecuteAsync<CursoredDisqusResponse<IEnumerable<DisqusUserActivity>>>(DisqusRequestMethod.Get,
                    DisqusEndpoints.Users.ListActivity, parameters)
                .ConfigureAwait(false);
        }

        public async Task<CursoredDisqusResponse<IEnumerable<DisqusUserActivity>>> ListActivityAsync(
            DisqusUserListActivityRequest request)
        {
            return await ListActivityAsync(null, request).ConfigureAwait(false);
        }

        public async Task<CursoredDisqusResponse<IEnumerable<DisqusForum>>> ListActiveForumsAsync(
            DisqusAccessToken accessToken, DisqusUserListActiveForumsRequest request)
        {
            Collection<KeyValuePair<string, string>> parameters = Parameters
                .WithOptionalParameter("access_token", accessToken)
                .WithMultipleParameters(request.Parameters);
            ...
            return await RequestProcessor
                .ExecuteAsync<CursoredDisqusResponse<IEnumerable<DisqusForum>>>(DisqusRequestMethod.Get,
                    DisqusEndpoints.Users.ListActiveForums, parameters)
                .ConfigureAwait(false);
        }

        public async Task<CursoredDisqusResponse<IEnumerable<DisqusForum>>> ListActiveForumsAsync(
            DisqusUserListActiveForumsRequest request)
        {
        ...
        public async Task<CursoredDisqusResponse<IEnumerable<DisqusUserBase>>> ListFollowersAsync(
            DisqusAccessToken accessToken, DisqusUserListFollowersRequest request)
        {
            Collection<KeyValuePair<string, string>> parameters = Parameters
                .WithOptionalParameter("access_token", accessToken)
                .WithMultipleParameters(request.Parameters);
            ...
            return await RequestProcessor
                .ExecuteAsync<CursoredDisqusResponse<IEnumerable<DisqusUserBase>>>(DisqusRequestMethod.Get,
                    DisqusEndpoints.Users.ListFollowers, parameters)
                .ConfigureAwait(false);
        }

        public async Task<CursoredDisqusResponse<IEnumerable<DisqusUserBase>>> ListFollowersAsync(
            DisqusUserListFollowersRequest request)
        {
            return await ListFollowersAsync(null, request).ConfigureAwait(false);
        }

        public async Task<CursoredDisqusResponse<IEnumerable<DisqusUserBase>>> ListFollowingAsync(
            DisqusAccessToken accessToken, DisqusUserListFollowingRequest request)
        {
            Collection<KeyValuePair<string, string>> parameters = Parameters
                .WithOptionalParameter("access_token", accessToken)
                .WithMultipleParameters(request.Parameters);
            ...
            return await RequestProcessor
                .ExecuteAsync<CursoredDisqusResponse<IEnumerable<DisqusUserBase>>>(DisqusRequestMethod.Get,
                    DisqusEndpoints.Users.ListFollowing, parameters)
                .ConfigureAwait(false);
        }

        public async Task<CursoredDisqusResponse<IEnumerable<DisqusUserBase>>> ListFollowingAsync(
            DisqusUserListFollowingRequest request)
        {
            return await ListFollowingAsync(null, request).ConfigureAwait(false);
        }

        public async Task<CursoredDisqusResponse<IEnumerable<DisqusForum>>> ListFollowingForumsAsync(
            DisqusAccessToken accessToken, DisqusUserListFollowingForumsRequest request)
        {
            Collection<KeyValuePair<string, string>> parameters = Parameters
                .WithOptionalParameter("access_token", accessToken)
                .WithMultipleParameters(request.Parameters);
            ...
            return await RequestProcessor
                .ExecuteAsync<CursoredDisqusResponse<IEnumerable<DisqusForum>>>(DisqusRequestMethod.Get,
                    DisqusEndpoints.Users.ListFollowingForums, parameters)
                .ConfigureAwait(false);
        }

        public async Task<CursoredDisqusResponse<IEnumerable<DisqusForum>>> ListFollowingForumsAsync(
            DisqusUserListFollowingForumsRequest request)
        {
        ...
        public async Task<CursoredDisqusResponse<IEnumerable<DisqusForum>>> ListForumsAsync(
            DisqusUserListForumsRequest request)
        {
            return await ListForumsAsync(null, request).ConfigureAwait(false);
        }

        public async Task<DisqusResponse<IEnumerable<DisqusForum>>> ListMostActiveForumsAsync(
            DisqusAccessToken accessToken, DisqusUserListMostActiveForumsRequest request)
        {
            Collection<KeyValuePair<string, string>> parameters = Parameters
                .WithOptionalParameter("access_token", accessToken)
                .WithMultipleParameters(request.Parameters);
            ...
            return await RequestProcessor
                .ExecuteAsync<DisqusResponse<IEnumerable<DisqusForum>>>(DisqusRequestMethod.Get,
                    DisqusEndpoints.Users.ListMostActiveForums, parameters)
                .ConfigureAwait(false);
        }

        public async Task<DisqusResponse<IEnumerable<DisqusForum>>> ListMostActiveForumsAsync(
            DisqusUserListMostActiveForumsRequest request)
        {
        ...
        public async Task<CursoredDisqusResponse<IEnumerable<DisqusPost>>> ListPostsAsync(DisqusAccessToken accessToken,
            DisqusUserListPostsRequest request)
        {
            Collection<KeyValuePair<string, string>> parameters = Parameters
                .WithOptionalParameter("access_token", accessToken)
                .WithMultipleParameters(request.Parameters);
            ...
            return await RequestProcessor
                .ExecuteAsync<CursoredDisqusResponse<IEnumerable<DisqusPost>>>(DisqusRequestMethod.Get,
                    DisqusEndpoints.Users.ListPosts, parameters)
                .ConfigureAwait(false);
        }
        ...
        public async Task<DisqusResponse<string>> ReportAsync(DisqusAccessToken accessToken, int userId,
            DisqusUserReportReason reason)
        {
            Collection<KeyValuePair<string, string>> parameters = Parameters
                .WithParameter("access_token", accessToken)
            ...
            return await RequestProcessor
                .ExecuteAsync<DisqusResponse<string>>(DisqusRequestMethod.Post, DisqusEndpoints.Users.Report,
                    parameters)
                .ConfigureAwait(false);
        }

        public async Task<DisqusResponse<string>> ReportAsync(DisqusAccessToken accessToken, string username,
            DisqusUserReportReason reason)
        {
            Collection<KeyValuePair<string, string>> parameters = Parameters
                .WithParameter("access_token", accessToken)
        ...
        public async Task UnfollowAsync(DisqusAccessToken accessToken, int userId)
        {
            ...
            await RequestProcessor
                .ExecuteAsync<DisqusResponse<List<string>>>(DisqusRequestMethod.Post, DisqusEndpoints.Users.Unfollow,
                    parameters)
                .ConfigureAwait(false);
        }
