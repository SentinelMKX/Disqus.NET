...
namespace Disqus.NET
{
    ...
    public interface IDisqusUsersApi
    {
        ...
        /// <returns></returns>
        Task<CursoredDisqusResponse<IEnumerable<DisqusInterestingObject<DisqusUser>>>> InterestingUsersAsync(
        ...
        /// <returns></returns>
        Task<CursoredDisqusResponse<IEnumerable<DisqusUserActivity>>> ListActivityAsync(DisqusAccessToken accessToken,
        ...
        /// <param name="request"></param>
        /// <returns></returns>
        Task<CursoredDisqusResponse<IEnumerable<DisqusUserActivity>>> ListActivityAsync(
            DisqusUserListActivityRequest request);
        ...
        /// <param name="request"></param>
        /// <returns></returns>
        Task<CursoredDisqusResponse<IEnumerable<DisqusForum>>> ListActiveForumsAsync(DisqusAccessToken accessToken,
        ...
        /// <param name="request"></param>
        /// <returns></returns>
        Task<CursoredDisqusResponse<IEnumerable<DisqusForum>>> ListActiveForumsAsync(
            DisqusUserListActiveForumsRequest request);
        ...
        /// <param name="request"></param>
        /// <returns></returns>
        Task<CursoredDisqusResponse<IEnumerable<DisqusUserBase>>> ListFollowingAsync(DisqusAccessToken accessToken,
        ...
        /// <param name="request"></param>
        /// <returns></returns>
        Task<CursoredDisqusResponse<IEnumerable<DisqusUserBase>>> ListFollowingAsync(
            DisqusUserListFollowingRequest request);
        ...
        /// <param name="request"></param>
        /// <returns></returns>
        Task<CursoredDisqusResponse<IEnumerable<DisqusForum>>> ListFollowingForumsAsync(DisqusAccessToken accessToken,
        ...
        /// <param name="request"></param>
        /// <returns></returns>
        Task<CursoredDisqusResponse<IEnumerable<DisqusForum>>> ListFollowingForumsAsync(
            DisqusUserListFollowingForumsRequest request);
        ...
        /// <param name="request"></param>
        /// <returns></returns>
        Task<CursoredDisqusResponse<IEnumerable<DisqusForum>>> ListForumsAsync(DisqusAccessToken accessToken,
        ...
        /// <param name="request"></param>
        /// <returns></returns>
        Task<DisqusResponse<IEnumerable<DisqusForum>>> ListMostActiveForumsAsync(DisqusAccessToken accessToken,
        ...
        /// <param name="request"></param>
        /// <returns></returns>
        Task<DisqusResponse<IEnumerable<DisqusForum>>> ListMostActiveForumsAsync(
            DisqusUserListMostActiveForumsRequest request);
        ...
        /// <returns></returns>
        Task<DisqusResponse<string>> ReportAsync(DisqusAccessToken accessToken, int userId,
        ...
        /// <param name="reason"></param>
        /// <returns></returns>
        Task<DisqusResponse<string>> ReportAsync(DisqusAccessToken accessToken, string userName,
            DisqusUserReportReason reason);
        ...
        /// <param name="request"></param>
        /// <returns></returns>
        Task<DisqusResponse<DisqusUser>> UpdateProfileAsync(DisqusAccessToken accessToken,
