...
namespace Disqus.NET
{
    public interface IDisqusCategoryApi
    {
        ...
        /// <returns></returns>
        Task<DisqusResponse<DisqusCategory>> CreateAsync(DisqusAccessToken accessToken,
        ...
        /// <param name="request"></param>
        /// <returns></returns>
        Task<CursoredDisqusResponse<List<DisqusCategory>>> ListAsync(DisqusAccessToken accessToken,
        ...
        /// <param name="request"></param>
        /// <returns></returns>
        Task<CursoredDisqusResponse<IEnumerable<DisqusThread>>> ListThreadsAsync(
            DisqusCategoryListThreadsRequest request);
    }
}