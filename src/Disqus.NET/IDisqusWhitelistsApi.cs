...
namespace Disqus.NET
{
    public interface IDisqusWhitelistsApi
    {
        ...
        /// <returns></returns>
        Task<DisqusResponse<IEnumerable<DisqusWhitelistEntry>>> AddAsync(DisqusAccessToken accessToken,
        ...
        /// <param name="request"></param>
        /// <returns></returns>
        Task<CursoredDisqusResponse<IEnumerable<DisqusWhitelistEntry>>> ListAsync(DisqusAccessToken accessToken,
            DisqusWhitelistListRequest request);
        ...
        /// <param name="request"></param>
        /// <returns></returns>
        Task<DisqusResponse<IEnumerable<DisqusWhitelistEntry>>> RemoveAsync(DisqusAccessToken accessToken,
